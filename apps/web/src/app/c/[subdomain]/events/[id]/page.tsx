...
import { Calendar, MapPin, Ticket, ChevronLeft, Heart, Share2, Globe, Twitter, Instagram, Linkedin, Star, ArrowLeft, LogIn } from "lucide-react";
import Link from "next/link";
import { notFound, useRouter } from "next/navigation";
import clsx from "clsx";

export default function PublicEventDetailPage({ params }: { params: Promise<{ subdomain: string, id: string }> }) {
                            ...
                            {isLoggedIn ? (
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3 bg-stone-50 border border-stone-200 rounded-xl p-1.5 pr-4">
                                        ...
                                        <div>
                                            <div className="text-xs font-bold text-text-main">Jane Doe</div>
                    ...
                    <div className="lg:col-span-2 space-y-8 animate-in slide-in-from-bottom-2 delay-100 duration-700 fill-mode-both">
                        ...
                        <div>
                            ...
                            <div className="prose prose-stone max-w-none prose-lg">
                                ...
                                <ul className="mt-6 space-y-3 list-disc list-inside text-stone-600">
                                    <li>Modern yazılım mimarileri ve best practice'ler</li>
                                    <li>Ölçeklenebilir sistem tasarımı stratejileri</li>
                                    <li>Microservices vs Monolith: Gerçek dünya senaryoları</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="sticky top-40 space-y-6">
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl shadow-stone-200/50 border border-stone-100">
                                ...
                                <div className="space-y-6 mb-8">
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-stone-600 text-sm font-medium">{new Date(event.startDate).toLocaleDateString('tr-TR', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                                            <p className="text-stone-400 text-xs mt-0.5 font-medium bg-stone-50 inline-block px-1.5 py-0.5 rounded border border-stone-100">{new Date(event.startDate).toLocaleTimeString('tr-TR', { hour: '2-digit', minute: '2-digit' })}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-stone-600 text-sm font-medium decoration-rose-500">Ücretsiz</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p className="text-center text-xs text-stone-400 mt-5 font-medium">
                                    <strong className="text-teal-600">{event.registeredCount} kişi</strong> şimdiden yerini ayırttı!
                                </p>
                            </div>
